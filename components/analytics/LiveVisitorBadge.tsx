...
export default function LiveVisitorBadge() {
  ...
  return (
    <motion.div
      ...
      className="inline-flex items-center gap-4 px-4 py-2 bg-white/70 backdrop-blur-md border border-black/10 rounded-full shadow-sm hover:shadow hover:border-black/20 transition-all cursor-default"
    >
